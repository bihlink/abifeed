...
<div class="container"> 
	...
	<div class="row g-0">
		<div class="col-md-4">
		<img src="https://nitter.net/pic/pbs.twimg.com%2Fprofile_images%2F754610612345434112%2Fj6w9SJYW_400x400.jpg" class="img-fluid rounded-start" alt="@abidnev">
		</div>
		<div class="col-md-8">
		<div class="card-body p-0">
			<img src="https://nitter.net/pic/https%3A%2F%2Fpbs.twimg.com%2Fprofile_banners%2F555564058%2F1448652504%2F1500x500" class="img-fluid rounded-start" alt="@abidnev">
    ...
    <div class="row row-cols-1 row-cols-md-2 g-3">
		...
		foreach ($feed->get_items() as $item):
			...
			$desc = str_replace('https://nitter.net/search', '', $desc);
		...
		?>
			...
			<div class="col">
                ...
                <?php
					...
					$twlink = str_replace('nitter.net', 'twitter.com', $twlink)
					?>
